...
public final class ChatServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.example.chat.ChatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.chat.grpc.ChatMessage,
      com.example.chat.grpc.ChatMessage> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Chat",
      requestType = com.example.chat.grpc.ChatMessage.class,
      responseType = com.example.chat.grpc.ChatMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.chat.grpc.ChatMessage,
      com.example.chat.grpc.ChatMessage> getChatMethod() {
    io.grpc.MethodDescriptor<com.example.chat.grpc.ChatMessage, com.example.chat.grpc.ChatMessage> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod =
              io.grpc.MethodDescriptor.<com.example.chat.grpc.ChatMessage, com.example.chat.grpc.ChatMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.chat.grpc.ChatMessage.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.example.chat.grpc.ChatMessage> chat(
        io.grpc.stub.StreamObserver<com.example.chat.grpc.ChatMessage> responseObserver) {
  ...
  public static final class ChatServiceStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.example.chat.grpc.ChatMessage> chat(
        io.grpc.stub.StreamObserver<com.example.chat.grpc.ChatMessage> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.example.chat.grpc.ChatMessage,
              com.example.chat.grpc.ChatMessage>(
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.chat.grpc.ChatProto.getDescriptor();
    }
